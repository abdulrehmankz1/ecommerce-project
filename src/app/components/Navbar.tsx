...
const Navbar = () => {
  return (
    ...
    <div className='pt-7'>
    <ul className="flex justify-between flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                <li>
